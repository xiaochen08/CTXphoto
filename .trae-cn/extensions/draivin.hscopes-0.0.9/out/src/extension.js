...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerTextEditorCommand('hscopes.reloadCurrentDocument', (editor) => {
...
async function openDocument(doc) {
    for (let entry of blacklist) {
        if (doc.fileName.startsWith(entry))
            return;
    }
    try {
